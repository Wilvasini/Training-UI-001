...
var ngColumn = function (config, $scope, grid, domUtilityService, $templateCache, $utils) {
    ...
    self.sort = function(evt) {
        ...
        //var dir = self.sortDirection === ASC ? DESC : ASC; // orginal source code
        var dir = self.sortDirection === DESC ? ASC : DESC; // customized changes in ng grid to decending order as default sorting by MWC Team
